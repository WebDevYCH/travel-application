...
TripSchema.statics.comment = function(tripId, commentId) {
	return commentOn(this, tripId, commentId);
};

TripSchema.statics.uncomment = function(tripId, commentId) {
	return deleteComment(this, tripId, commentId);
};
